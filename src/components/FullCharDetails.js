...
const FullCharDetails = (props) => {
    ...
    useEffect(() => {
        ...
        setCreatedDate(new Date(charState.data.created).toLocaleDateString('en-gb'));
        pullEpisodeData();
    }, [])
            ...
            return (
                <div style={{alignItems: 'center'}}>
                    <Button 
                        ...
                        style={{height: 'auto', float: 'left', marginTop: '50px', marginLeft: '25px'}}
                        >
                            Go Back
                    </Button>
                    <div className="character-details-card" >
                        <div className="character-details-container">
                            <img 
                                src={charState.data.image} alt="Character Image" 
