    ...
    const drawer = (
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            ...
            <form className={classes.form} onSubmit={e => handleQuerySubmit(e)}>
                <label htmlFor="outlined-basic" style={{fontSize: '12px', marginBottom: '-15px'}}>Name</label>
                <TextField 
                    onChange={e => {handleQueryChange(e)}}
                    id='outlined-basic' 
                />
                <label style={{fontSize: "12px", marginBottom: '-15px'}} htmlFor="status">Status</label>
                <Select 
                    id='status'
                    type='submit'
                ...
                <label style={{fontSize: '12px', marginBottom: '-15px'}} htmlFor='gender'>Gender</label>
                <Select 
                    id='gender'
